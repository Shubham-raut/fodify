...
function RestaurentDetails(props) {
  ...
  return (
    <div>
          ...
          <div className="resDetails_inner_container">
            ...
            <div className="resDetails_right_container">
              ...
              <div className="cost_rateX">
                <div className='res_ratingX'><i className="fa fa-star" aria-hidden="true"></i> {resData.data.user_rating.aggregate_rating}<span className="res_ratingX_sub">{resData.data.user_rating.votes}+ Ratings</span></div>
                <div className='res_costX'><i className="fa fa-inr" aria-hidden="true"></i> {resData.data.average_cost_for_two}<span className="res_costX_sub">Cost for Two</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <Dish toPayment={props.toPayment} />
    </div>
  );
}
